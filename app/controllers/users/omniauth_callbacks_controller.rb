...
class Users::OmniauthCallbacksController < Devise::OmniauthCallbacksController
  ...
  def kakao
    redirect_to "https://kauth.kakao.com/oauth/authorize?client_id=#{ENV['KAKAO_REST_API_KEY']}&redirect_uri=https://my-second-rails-app-wdefrg1234.c9users.io/users/auth/kakao/callback&response_type=code"
  end
  ...
  def kakao_auth
   ...
   base_response = RestClient.post(base_url,{grant_type: 'authorization_code',
                                             ...
                                             redirect_uri: 'https://my-second-rails-app-wdefrg1234.c9users.io/users/auth/kakao/callback',
                                             code: code})
    ...
    if @user.persisted?
      ...
      flash[:notice] = "카카오 로그인에 실패했습니다. 다시 시도해 주세요"
